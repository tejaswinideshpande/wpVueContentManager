...
var loadingSpinner = {
  ...
  construct : function() {
	...
	if(document.getElementById("openModalLoading")===null){
		...
		document.getElementById("openModalLoading").style.display = 'block';
	}
  },
