<template>
	<div class="container">
		<div v-if="isLoggedIn">
			...
			<hr />
			<section class="content is-small"><p class="title is-4 is-spaced">Total Pending Posts: {{tableData.length}}</p></section>
...
export default{
	...
	mounted: function(){
		...
		this.displayPendingPosts();
	},
	methods: {
		loginRedirect(){
			this.$router.push({name : 'Login', params: { redirectTo: 'pending' }});
		},
		validate(){
			var vm = this;
